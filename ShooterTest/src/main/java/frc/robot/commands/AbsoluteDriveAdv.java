...
public class AbsoluteDriveAdv extends Command
{
  ...
  public void execute()
  {
    if(!alliance.isPresent()){
      ...
      inversion = alliance.get() == DriverStation.Alliance.Red ? -1 : 1;
    }
    double headingX = 0;
    double headingY = 0;
    ...
    ChassisSpeeds desiredSpeeds = swerve.getTargetSpeeds(vX.getAsDouble() * inversion, vY.getAsDouble() * inversion, headingX, headingY);
    ...
    SmartDashboard.putNumber("headingadjust", headingAdjust.getAsDouble());
