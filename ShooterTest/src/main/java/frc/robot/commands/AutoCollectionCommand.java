...
public class AutoCollectionCommand extends ParallelCommandGroup {
  ...
  public AutoCollectionCommand(ShooterSubsystem shooter, ShoulderSubsystem shoulder) {
    ...
    addCommands(new ParallelCommandGroup(new AutoIntakeCommand(shooter, true), new ShoulderMoveCommand(shoulder, MovementValues.armDown, false)),
    new ShoulderMoveCommand(shoulder, MovementValues.armStow, true));
  }
}
